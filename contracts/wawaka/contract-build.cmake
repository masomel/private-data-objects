...
LIST(APPEND EMCC_BUILD_OPTIONS "-s STANDALONE_WASM=1")
LIST(APPEND EMCC_BUILD_OPTIONS "-s ASSERTIONS=1") # implies STACK_OVERFLOW_CHECK=1
LIST(APPEND EMCC_BUILD_OPTIONS "-s WARN_ON_UNDEFINED_SYMBOLS=0")
LIST(APPEND EMCC_BUILD_OPTIONS "-s ERROR_ON_UNDEFINED_SYMBOLS=0")

SET(EMCC_LINK_OPTIONS "${EMCC_BUILD_OPTIONS}")
LIST(APPEND EMCC_LINK_OPTIONS "-s INITIAL_MEMORY=${LINEAR_MEMORY}")
...
LIST(APPEND EMCC_LINK_OPTIONS "-nostdlib")
